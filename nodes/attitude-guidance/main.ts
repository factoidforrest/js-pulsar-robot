...
class AttitudeController {
    ...
    constructor(node: Node) {
        ...
        this.targetPoseTopic = this.node.createTopicSubscriber('auv.navigation.target_pose', targetPose);
        this.actuatorCommandTopic = this.node.createTopicPublisher('auv.control.actuators', actuatorCommand);
